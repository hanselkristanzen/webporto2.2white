...
export const nlpResearch: ResearchProject = {
  ...
  errorAnalysis: [
    {
      pair: "Refund Request ↔ Complaint",
      explanation:
        "Both intents share dissatisfaction-related vocabulary, so weaker models frequently confuse the two.",
    },
    {
      pair: "Payment Inquiry ↔ Order Status",
      explanation:
        "Users often combine both questions in a single message, which is difficult for a single-label classifier to separate cleanly.",
    },
    {
      pair: "Shipping Information ↔ Order Status",
      explanation:
        "Word2Vec struggled here specifically — the two intents produce very similar sentence vectors because of overlapping vocabulary.",
    },
  ],
  myContribution: [
